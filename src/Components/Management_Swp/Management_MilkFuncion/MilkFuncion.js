...
export default function MilkFuncion() {
  ...
  const addGroup = async () => {
        ...
        try {
          ...
          if (response.status === 200) {
            await getAllGroups();
            alert("Tạo Chức năng sữa thành công");
            setStateAdd("Create");
  ...
  const updateGroup = async () => {
      ...
      try {
        ...
        if (response.status === 200) {
          await getAllGroups();
          alert("Cập nhập Chức năng sữa thành công ");
        ...
        <div className="row">
          <div className="col-lg-12">
            <div className="panel-content">
              <h4 className="main-title">Chức năng sữa</h4>
              <button
                className="main-btn"
                onClick={() => {
          ...
          <div className="popup-meta">
            ...
            >
              ...
              >
                ...
                <input
                  required
                  placeholder="Nhập Chức năng sữa"
                  style={{
                    width: "100%",
                    padding: 10,
                  }}
              ...
              >
                ...
                { stateAdd == "Create" ? "Tạo Chức năng sữa" : "Cập nhật" }
              </button>
            </form>
          </div>
        </div>
