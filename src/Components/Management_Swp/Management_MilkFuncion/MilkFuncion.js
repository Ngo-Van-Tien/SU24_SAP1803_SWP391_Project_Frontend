...
export default function MilkFuncion() {
  ...
  const addGroup = async () => {
        ...
        try {
          const data = {
            milfuncion: document.getElementById("txtmilkfuncion").value,
          ...
          const response = await axios.post(
            "http://localhost:5106/api/MilkFunction/AddMilkFunction",
            formData,
            {
              headers: {
  ...
  const updateGroup = async () => {
      ...
      try {
        ...
        if (response.status === 200) {
          await getAllGroups();
          alert("Cập nhập dòng sữa thành công ");
  ...
  const getAllGroups = async () => {
    try {
      const response = await axios.get(
        "http://localhost:5106/api/MilkFunction/GetAll",
        {
          headers: {
            "Content-Type": "application/json"
          },
        ...
        <div className="row">
          <div className="col-lg-12">
            <div className="panel-content">
              <h4 className="main-title">Dòng sữa</h4>
              <button
                className="main-btn"
                onClick={() => {
          ...
          <div className="popup-meta">
            ...
            >
              ...
              >
                ...
                { stateAdd == "Create" ? "Tạo Dòng sữa" : "Cập nhật" }
              </button>
            </form>
          </div>
        </div>
